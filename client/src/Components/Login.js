        ...
        <div className='bg-purple-700 h-screen '>
            <div className='items-center justify-center '>
                ...
                <div className='flex items-center justify-center'>
                    ...
                    <div>
                        <img
                            className='bg-transparent ' src="../../public/Login.png" alt="" />
                    </div>
                    <form className="max-w-screen-lg w-2/4 mx-auto py-5"
                        ...
                        <div className='items-center justify-center flex'>
                            ...
                            <button
                                type="submit"
                                className=" text-purple-700 bg-white hover:bg-white focus:ring-4 focus:outline-none  font-bold rounded-2xl text-xl w-full sm:w-auto px-10 py-5 text-center"
                            >
                                Login
                            </button>
                        </div>
